...
*Defined in [extrinsics/fromMetadata/createUnchecked.ts:21](https://github.com/polkadot-js/api/blob/5ee2caf/packages/api-metadata/src/extrinsics/fromMetadata/createUnchecked.ts#L21)*
