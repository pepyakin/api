...
*Defined in [extrinsics/fromMetadata/createUnchecked.ts:21](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-metadata/src/extrinsics/fromMetadata/createUnchecked.ts#L21)*
