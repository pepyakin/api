...
*Defined in [storage/fromMetadata/createFunction.ts:40](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-metadata/src/storage/fromMetadata/createFunction.ts#L40)*
