...
*Defined in [SignerPayload.ts:43](https://github.com/polkadot-js/api/blob/67d6c50/packages/api/src/SignerPayload.ts#L43)*
...
*Defined in [SignerPayload.ts:63](https://github.com/polkadot-js/api/blob/67d6c50/packages/api/src/SignerPayload.ts#L63)*
