...
*Defined in [SubmittableExtrinsic.ts:66](https://github.com/polkadot-js/api/blob/2ddc87c/packages/api/src/SubmittableExtrinsic.ts#L66)*
...
*Defined in [SubmittableExtrinsic.ts:64](https://github.com/polkadot-js/api/blob/2ddc87c/packages/api/src/SubmittableExtrinsic.ts#L64)*
...
*Defined in [SubmittableExtrinsic.ts:73](https://github.com/polkadot-js/api/blob/2ddc87c/packages/api/src/SubmittableExtrinsic.ts#L73)*
...
*Defined in [SubmittableExtrinsic.ts:77](https://github.com/polkadot-js/api/blob/2ddc87c/packages/api/src/SubmittableExtrinsic.ts#L77)*
...
*Defined in [SubmittableExtrinsic.ts:81](https://github.com/polkadot-js/api/blob/2ddc87c/packages/api/src/SubmittableExtrinsic.ts#L81)*
...
*Defined in [SubmittableExtrinsic.ts:88](https://github.com/polkadot-js/api/blob/2ddc87c/packages/api/src/SubmittableExtrinsic.ts#L88)*
