...
*Defined in [promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/908e9a8/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [promise/Combinator.ts:74](https://github.com/polkadot-js/api/blob/908e9a8/packages/api/src/promise/Combinator.ts#L74)*
