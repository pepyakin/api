...
*Defined in [promise/types.ts:9](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api/src/promise/types.ts#L9)*
...
*Defined in [promise/types.ts:10](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api/src/promise/types.ts#L10)*
...
*Defined in [promise/types.ts:11](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api/src/promise/types.ts#L11)*