...
*Defined in [SubmittableExtrinsic.ts:30](https://github.com/polkadot-js/api/blob/b595428/packages/api/src/SubmittableExtrinsic.ts#L30)*
...
*Defined in [SubmittableExtrinsic.ts:35](https://github.com/polkadot-js/api/blob/b595428/packages/api/src/SubmittableExtrinsic.ts#L35)*
...
*Defined in [SubmittableExtrinsic.ts:109](https://github.com/polkadot-js/api/blob/b595428/packages/api/src/SubmittableExtrinsic.ts#L109)*
