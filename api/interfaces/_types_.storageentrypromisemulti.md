...
*Defined in [types.ts:102](https://github.com/polkadot-js/api/blob/fbd6bf1/packages/api/src/types.ts#L102)*
...
*Defined in [types.ts:103](https://github.com/polkadot-js/api/blob/fbd6bf1/packages/api/src/types.ts#L103)*
