...
*Defined in [types.ts:105](https://github.com/polkadot-js/api/blob/6fee15b/packages/api/src/types.ts#L105)*
...
*Defined in [types.ts:106](https://github.com/polkadot-js/api/blob/6fee15b/packages/api/src/types.ts#L106)*
