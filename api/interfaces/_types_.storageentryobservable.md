...
*Defined in [types.ts:91](https://github.com/polkadot-js/api/blob/71d4a7e/packages/api/src/types.ts#L91)*
...
*Defined in [types.ts:92](https://github.com/polkadot-js/api/blob/71d4a7e/packages/api/src/types.ts#L92)*
...
*Defined in [types.ts:94](https://github.com/polkadot-js/api/blob/71d4a7e/packages/api/src/types.ts#L94)*
