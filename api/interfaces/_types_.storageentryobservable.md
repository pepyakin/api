...
*Defined in [types.ts:83](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L83)*
...
*Defined in [types.ts:84](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L84)*
...
*Defined in [types.ts:86](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L86)*
...
*Defined in [types.ts:87](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L87)*
...
*Defined in [types.ts:88](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L88)*
...
*Defined in [types.ts:89](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L89)*
...
*Defined in [types.ts:90](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L90)*
...
*Defined in [types.ts:91](https://github.com/polkadot-js/api/blob/5899304/packages/api/src/types.ts#L91)*
