...
*Defined in [types.ts:297](https://github.com/polkadot-js/api/blob/891a342/packages/api/src/types.ts#L297)*
...
*Defined in [types.ts:307](https://github.com/polkadot-js/api/blob/891a342/packages/api/src/types.ts#L307)*
...
*Defined in [types.ts:302](https://github.com/polkadot-js/api/blob/891a342/packages/api/src/types.ts#L302)*
