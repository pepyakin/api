...
\+ **new ParachainDispatchOrigin**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enum_.enum.md)): *[ParachainDispatchOrigin](_interfaces_parachains_types_.parachaindispatchorigin.md)*
...
*Defined in [interfaces/parachains/types.ts:115](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/parachains/types.ts#L115)*
...
*Defined in [interfaces/parachains/types.ts:113](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/parachains/types.ts#L113)*
