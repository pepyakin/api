...
\+ **new ContractInfo**(`def`: `TypesDef` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enumtype_.enum.md)): *[ContractInfo](_interfaces_contracts_types_.contractinfo.md)*
...
*Defined in [interfaces/contracts/types.ts:31](https://github.com/polkadot-js/api/blob/14f018d/packages/types/src/interfaces/contracts/types.ts#L31)*
...
*Defined in [interfaces/contracts/types.ts:35](https://github.com/polkadot-js/api/blob/14f018d/packages/types/src/interfaces/contracts/types.ts#L35)*
...
*Defined in [interfaces/contracts/types.ts:29](https://github.com/polkadot-js/api/blob/14f018d/packages/types/src/interfaces/contracts/types.ts#L29)*
...
*Defined in [interfaces/contracts/types.ts:33](https://github.com/polkadot-js/api/blob/14f018d/packages/types/src/interfaces/contracts/types.ts#L33)*
