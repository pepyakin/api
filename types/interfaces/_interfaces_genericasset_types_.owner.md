...
\+ **new Owner**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enumtype_.enum.md)): *[Owner](_interfaces_genericasset_types_.owner.md)*
...
*Defined in [interfaces/genericAsset/types.ts:22](https://github.com/polkadot-js/api/blob/2a5fd1c/packages/types/src/interfaces/genericAsset/types.ts#L22)*
...
*Defined in [interfaces/genericAsset/types.ts:20](https://github.com/polkadot-js/api/blob/2a5fd1c/packages/types/src/interfaces/genericAsset/types.ts#L20)*
...
*Defined in [interfaces/genericAsset/types.ts:18](https://github.com/polkadot-js/api/blob/2a5fd1c/packages/types/src/interfaces/genericAsset/types.ts#L18)*
