...
\+ **new ExtrinsicOrHash**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enum_.enum.md)): *[ExtrinsicOrHash](_interfaces_rpc_types_.extrinsicorhash.md)*
...
*Defined in [interfaces/rpc/types.ts:29](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/rpc/types.ts#L29)*
...
*Defined in [interfaces/rpc/types.ts:25](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/rpc/types.ts#L25)*
...
*Defined in [interfaces/rpc/types.ts:27](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/rpc/types.ts#L27)*
...
*Defined in [interfaces/rpc/types.ts:23](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/rpc/types.ts#L23)*
