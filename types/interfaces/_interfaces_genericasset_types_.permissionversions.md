...
\+ **new PermissionVersions**(`def`: `TypesDef` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enumtype_.enum.md)): *[PermissionVersions](_interfaces_genericasset_types_.permissionversions.md)*
...
*Defined in [interfaces/genericAsset/types.ts:42](https://github.com/polkadot-js/api/blob/1b94f0c/packages/types/src/interfaces/genericAsset/types.ts#L42)*
...
*Defined in [interfaces/genericAsset/types.ts:40](https://github.com/polkadot-js/api/blob/1b94f0c/packages/types/src/interfaces/genericAsset/types.ts#L40)*
