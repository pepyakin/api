...
\+ **new PermissionVersions**(`def`: Record‹string, [InterfaceTypes](../modules/_types_.md#interfacetypes) | [Constructor](_types_.constructor.md)› | string[], `value?`: any, `index?`: undefined | number): *[PermissionVersions](_interfaces_genericasset_types_.permissionversions.md)*
...
*Defined in [interfaces/genericAsset/types.ts:43](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/genericAsset/types.ts#L43)*
...
*Defined in [interfaces/genericAsset/types.ts:41](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/genericAsset/types.ts#L41)*
