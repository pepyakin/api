...
\+ **new PermissionVersions**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enumtype_.enum.md)): *[PermissionVersions](_interfaces_genericasset_types_.permissionversions.md)*
...
*Defined in [interfaces/genericAsset/types.ts:43](https://github.com/polkadot-js/api/blob/53256fe/packages/types/src/interfaces/genericAsset/types.ts#L43)*
...
*Defined in [interfaces/genericAsset/types.ts:41](https://github.com/polkadot-js/api/blob/53256fe/packages/types/src/interfaces/genericAsset/types.ts#L41)*
