...
*Defined in [interfaces/session/types.ts:10](https://github.com/polkadot-js/api/blob/0d68f98/packages/types/src/interfaces/session/types.ts#L10)*
...
*Defined in [interfaces/session/types.ts:12](https://github.com/polkadot-js/api/blob/0d68f98/packages/types/src/interfaces/session/types.ts#L12)*
