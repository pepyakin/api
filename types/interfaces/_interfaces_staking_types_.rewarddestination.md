...
\+ **new RewardDestination**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enumtype_.enum.md)): *[RewardDestination](_interfaces_staking_types_.rewarddestination.md)*
...
*Defined in [interfaces/staking/types.ts:57](https://github.com/polkadot-js/api/blob/4115b8a/packages/types/src/interfaces/staking/types.ts#L57)*
...
*Defined in [interfaces/staking/types.ts:53](https://github.com/polkadot-js/api/blob/4115b8a/packages/types/src/interfaces/staking/types.ts#L53)*
...
*Defined in [interfaces/staking/types.ts:55](https://github.com/polkadot-js/api/blob/4115b8a/packages/types/src/interfaces/staking/types.ts#L55)*
