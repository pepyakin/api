...
\+ **new RewardDestination**(`def`: Record‹string, [InterfaceTypes](../modules/_types_.md#interfacetypes) | [Constructor](_types_.constructor.md)› | string[], `value?`: any, `index?`: undefined | number): *[RewardDestination](_interfaces_staking_types_.rewarddestination.md)*
...
*Defined in [interfaces/staking/types.ts:57](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/staking/types.ts#L57)*
...
*Defined in [interfaces/staking/types.ts:53](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/staking/types.ts#L53)*
...
*Defined in [interfaces/staking/types.ts:55](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/staking/types.ts#L55)*
