...
\+ **new NewAccountOutcome**(`def`: Record‹string, [InterfaceTypes](../modules/_types_.md#interfacetypes) | [Constructor](_types_.constructor.md)› | string[], `value?`: any, `index?`: undefined | number): *[NewAccountOutcome](_interfaces_deprecated_types_.newaccountoutcome.md)*
...
*Defined in [interfaces/deprecated/types.ts:35](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/deprecated/types.ts#L35)*
...
*Defined in [interfaces/deprecated/types.ts:33](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/deprecated/types.ts#L33)*
...
*Defined in [interfaces/deprecated/types.ts:31](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/deprecated/types.ts#L31)*
