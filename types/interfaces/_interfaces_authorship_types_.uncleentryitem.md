...
\+ **new UncleEntryItem**(`def`: Record‹string, [InterfaceTypes](../modules/_types_.md#interfacetypes) | [Constructor](_types_.constructor.md)› | string[], `value?`: any, `index?`: undefined | number): *[UncleEntryItem](_interfaces_authorship_types_.uncleentryitem.md)*
...
*Defined in [interfaces/authorship/types.ts:19](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/authorship/types.ts#L19)*
...
*Defined in [interfaces/authorship/types.ts:23](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/authorship/types.ts#L23)*
...
*Defined in [interfaces/authorship/types.ts:17](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/authorship/types.ts#L17)*
...
*Defined in [interfaces/authorship/types.ts:21](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/authorship/types.ts#L21)*
