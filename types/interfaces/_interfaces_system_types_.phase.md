...
\+ **new Phase**(`def`: Record‹string, [InterfaceTypes](../modules/_types_.md#interfacetypes) | [Constructor](_types_.constructor.md)› | string[], `value?`: any, `index?`: undefined | number): *[Phase](_interfaces_system_types_.phase.md)*
...
*Defined in [interfaces/system/types.ts:47](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/system/types.ts#L47)*
...
*Defined in [interfaces/system/types.ts:45](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/system/types.ts#L45)*
...
*Defined in [interfaces/system/types.ts:49](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/types/src/interfaces/system/types.ts#L49)*
