...
\+ **new Forcing**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enum_.enum.md)): *[Forcing](_interfaces_staking_types_.forcing.md)*
...
*Defined in [interfaces/staking/types.ts:34](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/staking/types.ts#L34)*
...
*Defined in [interfaces/staking/types.ts:36](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/staking/types.ts#L36)*
...
*Defined in [interfaces/staking/types.ts:32](https://github.com/polkadot-js/api/blob/71d4a7e/packages/types/src/interfaces/staking/types.ts#L32)*
