...
\+ **new StorageFunctionModifierV0**(`def`: `Record<string, InterfaceTypes | Constructor>` | string[], `value?`: any, `index?`: number | [Enum](../classes/_codec_enumtype_.enum.md)): *[StorageFunctionModifierV0](_interfaces_metadata_types_.storagefunctionmodifierv0.md)*
...
*Defined in [interfaces/metadata/types.ts:348](https://github.com/polkadot-js/api/blob/c7c76f6/packages/types/src/interfaces/metadata/types.ts#L348)*
...
*Defined in [interfaces/metadata/types.ts:346](https://github.com/polkadot-js/api/blob/c7c76f6/packages/types/src/interfaces/metadata/types.ts#L346)*
...
*Defined in [interfaces/metadata/types.ts:350](https://github.com/polkadot-js/api/blob/c7c76f6/packages/types/src/interfaces/metadata/types.ts#L350)*
