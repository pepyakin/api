...
*Defined in [codec/create/createType.ts:59](https://github.com/polkadot-js/api/blob/908e9a8/packages/types/src/codec/create/createType.ts#L59)*
...
*Defined in [codec/create/createType.ts:45](https://github.com/polkadot-js/api/blob/908e9a8/packages/types/src/codec/create/createType.ts#L45)*
