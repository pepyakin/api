...
*Defined in [accounts/indexes.ts:15](https://github.com/polkadot-js/api/blob/9be9782/packages/api-derive/src/accounts/indexes.ts#L15)*
...
*Defined in [accounts/indexes.ts:34](https://github.com/polkadot-js/api/blob/9be9782/packages/api-derive/src/accounts/indexes.ts#L34)*
