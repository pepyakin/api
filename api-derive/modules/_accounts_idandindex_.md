...
*Defined in [accounts/idAndIndex.ts:17](https://github.com/polkadot-js/api/blob/14f018d/packages/api-derive/src/accounts/idAndIndex.ts#L17)*
...
*Defined in [accounts/idAndIndex.ts:32](https://github.com/polkadot-js/api/blob/14f018d/packages/api-derive/src/accounts/idAndIndex.ts#L32)*
