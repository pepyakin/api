...
*Defined in [democracy/referendumInfo.ts:17](https://github.com/polkadot-js/api/blob/9be9782/packages/api-derive/src/democracy/referendumInfo.ts#L17)*
...
*Defined in [democracy/referendumInfo.ts:30](https://github.com/polkadot-js/api/blob/9be9782/packages/api-derive/src/democracy/referendumInfo.ts#L30)*
