...
*Defined in [chain/subscribeNewHead.ts:14](https://github.com/polkadot-js/api/blob/b595428/packages/api-derive/src/chain/subscribeNewHead.ts#L14)*
...
*Defined in [chain/subscribeNewHead.ts:29](https://github.com/polkadot-js/api/blob/b595428/packages/api-derive/src/chain/subscribeNewHead.ts#L29)*
