...
*Defined in [chain/subscribeNewHead.ts:14](https://github.com/polkadot-js/api/blob/7a08b37/packages/api-derive/src/chain/subscribeNewHead.ts#L14)*
...
*Defined in [chain/subscribeNewHead.ts:29](https://github.com/polkadot-js/api/blob/7a08b37/packages/api-derive/src/chain/subscribeNewHead.ts#L29)*
