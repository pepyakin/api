...
*Defined in [democracy/referendumVotesFor.ts:18](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api-derive/src/democracy/referendumVotesFor.ts#L18)*
