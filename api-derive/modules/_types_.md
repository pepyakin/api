...
*Defined in [types.ts:20](https://github.com/polkadot-js/api/blob/92044d4/packages/api-derive/src/types.ts#L20)*
...
*Defined in [types.ts:88](https://github.com/polkadot-js/api/blob/92044d4/packages/api-derive/src/types.ts#L88)*
...
*Defined in [types.ts:96](https://github.com/polkadot-js/api/blob/92044d4/packages/api-derive/src/types.ts#L96)*