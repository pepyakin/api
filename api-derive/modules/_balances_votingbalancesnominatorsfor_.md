...
*Defined in [balances/votingBalancesNominatorsFor.ts:17](https://github.com/polkadot-js/api/blob/9954477/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L17)*
