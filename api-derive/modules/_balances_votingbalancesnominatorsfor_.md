...
*Defined in [balances/votingBalancesNominatorsFor.ts:17](https://github.com/polkadot-js/api/blob/1706309/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L17)*
