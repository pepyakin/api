...
*Defined in [balances/votingBalancesNominatorsFor.ts:17](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L17)*
