...
*Defined in [mock/types.ts:9](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/rpc-provider/src/mock/types.ts#L9)*
...
*Defined in [mock/types.ts:10](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/rpc-provider/src/mock/types.ts#L10)*
