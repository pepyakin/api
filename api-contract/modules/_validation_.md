...
*Defined in [validation.ts:42](https://github.com/polkadot-js/api/blob/9dd0c6c/packages/api-contract/src/validation.ts#L42)*
...
*Defined in [validation.ts:9](https://github.com/polkadot-js/api/blob/9dd0c6c/packages/api-contract/src/validation.ts#L9)*
...
*Defined in [validation.ts:21](https://github.com/polkadot-js/api/blob/9dd0c6c/packages/api-contract/src/validation.ts#L21)*
...
*Defined in [validation.ts:29](https://github.com/polkadot-js/api/blob/9dd0c6c/packages/api-contract/src/validation.ts#L29)*
