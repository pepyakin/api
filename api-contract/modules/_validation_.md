...
*Defined in [validation.ts:42](https://github.com/polkadot-js/api/blob/c90a4ba/packages/api-contract/src/validation.ts#L42)*
...
*Defined in [validation.ts:9](https://github.com/polkadot-js/api/blob/c90a4ba/packages/api-contract/src/validation.ts#L9)*
...
*Defined in [validation.ts:21](https://github.com/polkadot-js/api/blob/c90a4ba/packages/api-contract/src/validation.ts#L21)*
...
*Defined in [validation.ts:29](https://github.com/polkadot-js/api/blob/c90a4ba/packages/api-contract/src/validation.ts#L29)*
