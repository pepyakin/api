...
*Defined in [types.ts:71](https://github.com/polkadot-js/api/blob/1706309/packages/api-contract/src/types.ts#L71)*
...
*Defined in [types.ts:11](https://github.com/polkadot-js/api/blob/1706309/packages/api-contract/src/types.ts#L11)*
...
*Defined in [types.ts:32](https://github.com/polkadot-js/api/blob/1706309/packages/api-contract/src/types.ts#L32)*