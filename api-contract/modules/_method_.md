...
*Defined in [method.ts:29](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api-contract/src/method.ts#L29)*
...
*Defined in [method.ts:41](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api-contract/src/method.ts#L41)*
...
*Defined in [method.ts:11](https://github.com/polkadot-js/api/blob/19c3e4b/packages/api-contract/src/method.ts#L11)*
