...
*Defined in [RxCode.ts:51](https://github.com/polkadot-js/api/blob/400f33f/packages/api-contract/src/RxCode.ts#L51)*
...
*Defined in [RxCode.ts:59](https://github.com/polkadot-js/api/blob/400f33f/packages/api-contract/src/RxCode.ts#L59)*
