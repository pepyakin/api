...
*Defined in [RxBlueprint.ts:38](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/api-contract/src/RxBlueprint.ts#L38)*
...
*Defined in [RxBlueprint.ts:46](https://github.com/polkadot-js/api/blob/9b1aa6a/packages/api-contract/src/RxBlueprint.ts#L46)*
