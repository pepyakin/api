...
*Defined in [RxBlueprint.ts:38](https://github.com/polkadot-js/api/blob/724c4b8/packages/api-contract/src/RxBlueprint.ts#L38)*
...
*Defined in [RxBase.ts:14](https://github.com/polkadot-js/api/blob/724c4b8/packages/api-contract/src/RxBase.ts#L14)*
...
*Defined in [RxBase.ts:16](https://github.com/polkadot-js/api/blob/724c4b8/packages/api-contract/src/RxBase.ts#L16)*
...
*Defined in [RxBase.ts:18](https://github.com/polkadot-js/api/blob/724c4b8/packages/api-contract/src/RxBase.ts#L18)*
...
*Defined in [RxBlueprint.ts:46](https://github.com/polkadot-js/api/blob/724c4b8/packages/api-contract/src/RxBlueprint.ts#L46)*
