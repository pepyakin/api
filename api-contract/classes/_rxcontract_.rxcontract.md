...
*Defined in [RxContract.ts:29](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-contract/src/RxContract.ts#L29)*
...
*Defined in [RxContract.ts:27](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-contract/src/RxContract.ts#L27)*
