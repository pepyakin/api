...
*Defined in [RxContract.ts:29](https://github.com/polkadot-js/api/blob/c90a4ba/packages/api-contract/src/RxContract.ts#L29)*
...
*Defined in [RxContract.ts:27](https://github.com/polkadot-js/api/blob/c90a4ba/packages/api-contract/src/RxContract.ts#L27)*
