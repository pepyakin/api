...
*Defined in [RxContract.ts:29](https://github.com/polkadot-js/api/blob/9bd5c09/packages/api-contract/src/RxContract.ts#L29)*
...
*Defined in [RxContract.ts:27](https://github.com/polkadot-js/api/blob/9bd5c09/packages/api-contract/src/RxContract.ts#L27)*
