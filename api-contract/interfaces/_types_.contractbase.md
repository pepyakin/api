...
*Defined in [types.ts:80](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-contract/src/types.ts#L80)*
...
*Defined in [types.ts:81](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-contract/src/types.ts#L81)*
...
*Defined in [types.ts:82](https://github.com/polkadot-js/api/blob/3d8fbcf/packages/api-contract/src/types.ts#L82)*